...
package com.rhc.lab.kie.common;
...
public class QueryUtils {
		...
		if (clazz != null) {
			...
			for (Field field : fields) {
				...
				if (queryInfo != null) {
					...
					queryCommands.add(KieServices.Factory.get().getCommands()
	...
	public static Collection<?> extractCollectionFromExecutionResults(
			ExecutionResults exectionResults, String queryName, String binding) {
		Collection<Object> list = new ArrayList<Object>();
		if (exectionResults != null) {
			QueryResults queryResult = (QueryResults) exectionResults
					.getValue(queryName);
			if (queryResult != null) {
